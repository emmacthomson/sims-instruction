...
If you do not have a Jekyll site already, start by cloning this repository.

If you already do have a Jekyll site, you can certainly apply this theme to your existing
...
Jekyll Clean
============
This theme is based on **Jekyll Clean**: 
